...
{
    public sealed class DebugConsoleController_ : MonoBehaviour, ISingltone<DebugConsoleController_>
    {
        ...
        public static DebugConsoleController_ Instance_ { get; private set; }
        DebugConsoleController_ ISingltone<DebugConsoleController_>.Singltone
        {
            get => Instance_;
            set => Instance_ = value;
        }
        void ISingltone<DebugConsoleController_>.Destroy() => Destroy(this);
